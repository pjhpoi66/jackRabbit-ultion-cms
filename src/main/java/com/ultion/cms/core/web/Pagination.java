...
public class Pagination implements Serializable {
    ...
    private static final long serialVersionUID = -1303994309982019162L;
    ...
    private List<FileDto> viewList; // view Count
    private boolean popupChk = true; //팝업창 확인
    ...
    public void setPageNo(int pageNo) {
        ...
        this.setStartRowNum(endRowNum - (pageSize - 1) -1);
    }
    ...
    private void makePaging() {
        ...
        viewList = new ArrayList<FileDto>();
        ...
        if (this.endRowNum > this.totalCount - 1) {
            this.endRowNum = this.totalCount - 1;
        }
